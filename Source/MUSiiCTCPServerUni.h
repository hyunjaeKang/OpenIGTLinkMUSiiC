...
#ifndef __MUSIIC_TCP_SERVER_UNI_
#define __MUSIIC_TCP_SERVER_UNI_
...
class IGTLMCommon_EXPORT MUSiiCTCPServerUni : public MUSiiCTCPIO 
{
public: ///Operation
	/** Standard class typedefs. */
	typedef MUSiiCTCPServerUni			Self;
	typedef MUSiiCTCPIO					Superclass;
	typedef SmartPointer<Self>			Pointer;
	typedef SmartPointer<const Self>	ConstPointer;

	igtlNewMacro(MUSiiCTCPServerUni);  
	igtlTypeMacro(MUSiiCTCPServerUni, MUSiiCTCPIO);
