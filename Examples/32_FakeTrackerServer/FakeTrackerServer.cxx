...
/***************************************************************************
This an example is about FakeTrackerServer.
...
int main(int argc, char** argv)
{
	...
	while(bTask)
	{
		...
		{
			//igtl::MessageBase::Pointer msg = GetDummyTrackingDataMessage();
			...
			////tracker = RetrieveMessage<igtl::TrackingDataMessage::Pointer, igtl::TrackingDataMessage>(msg, false);
			///*tracker = RetrieveMessagefromIODevice2<igtl::TrackingDataMessage::Pointer, igtl::TrackingDataMessage>(msg);*/
			//ReftrackingData = GetReferenceTrackingData(tracker);

			pServer->PutIGTLMessage(GetDummyTrackingDataMessage());
