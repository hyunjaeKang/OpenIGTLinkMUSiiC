...
void SetFrameRate()
{
	std::cout << "Enter frame rates per second" << std::endl;
	int fps;
	scanf("%d", &fps);
	gFrameRate = 1000/fps;
}
...
int main(int argc, char** argv)
{
	...
	//_CrtSetBreakAlloc(319); /// CallbackInterface Part
	//_CrtSetBreakAlloc(135); /// CallbackInterface Part
	//_CrtSetBreakAlloc(540);
	//_CrtSetBreakAlloc(577);  //OpenIGTLinkThread
	//_CrtSetBreakAlloc(592);  //OpenIGTLinkThread
