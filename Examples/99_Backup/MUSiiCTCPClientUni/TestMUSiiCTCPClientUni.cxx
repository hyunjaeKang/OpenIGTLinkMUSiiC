...
public:
	...
	void printCallbackInfo(std::string description, bool data, int numOfRun, int Taskinfo, void* ptr, void* data1, void* data2, void* data3)
	{
		...
		if(!data)
		{
			...
			m_pigtlMsgVector->concurrent_try_get_pop_front(msg);
...
int main (int argc, char* argv[])
{
	...
	//int r = m_pClient->ConnectToHost("localhost", 23478);//"10.162.34.40", 23877
	//int r = m_pClient->ConnectToHost("10.162.34.40", 23877);
	int r = m_pClient->ConnectToHost("localhost", 23478);
	//igtl::Sleep(5000);
	m_pClient->WaitTask();
