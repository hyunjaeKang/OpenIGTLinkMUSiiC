...
class TxTask1:public MUSiiCTaskInterfaceAbstract<igtl::MessageBase::Pointer, igtl::MessageBase::Pointer>
{
  public: // Operations
...
protected:
	...
	virtual int TaskFunction(int numOfRun, int taskInfo, void* ptr = NULL, void* data1 = NULL, void* data2 = NULL, void* data3 = NULL)
	{
		if(this->m_pVOutputDATA_IF_Set->IsMUSiiCVectors())
		{
			...
			img->SetDeviceName("Dummy Image");
			img->AllocateScalars();

			MUSiiC_LOG(logINFO) << " <<<<<< TxTask1 m_pVOutputDATA_IF_Set::Try_push_back_ALL,";
			MUSiiC_LOG(logINFO) << "data type    " << img->GetDeviceType()<< " Device Name: "<< img->GetDeviceName();
			MUSiiC_LOG(logINFO);
			this->m_pVOutputDATA_IF_Set->Try_push_back_ALL((igtl::MessageBase::Pointer)img);
...
class TxTask2:public MUSiiCTaskInterfaceAbstract<igtl::MessageBase::Pointer, igtl::MessageBase::Pointer>
{
  public: // Operations
...
protected:
	...
	virtual int TaskFunction(int numOfRun, int taskInfo, void* ptr = NULL, void* data1 = NULL, void* data2 = NULL, void* data3 = NULL)
	{
		if(this->m_pVOutputDATA_IF_Set->IsMUSiiCVectors())
		{
			...
			str->SetDeviceName("Dummy String Message");
			str->SetString("Hello");
			
			
			MUSiiC_LOG(logINFO) << " <<<<<< TxTask2 m_pVOutputDATA_IF_Set::Try_push_back_ALL,";
			MUSiiC_LOG(logINFO) << "data type    " << str->GetDeviceType()<< " Device Name: "<< str->GetDeviceName();
			MUSiiC_LOG(logINFO);
			this->m_pVOutputDATA_IF_Set->Try_push_back_ALL((igtl::MessageBase::Pointer)str);
			m_iValue++;
...
class RxTask1:public MUSiiCTaskInterfaceAbstract<igtl::MessageBase::Pointer, igtl::MessageBase::Pointer>
{
  public: // Operations
...
protected:
	...
	virtual int TaskFunction(int numOfRun, int taskInfo, void* ptr = NULL, void* data1 = NULL, void* data2 = NULL, void* data3 = NULL)
	{
		if(this->m_pVInputDATA_IF_Set->IsMUSiiCVectors())
		{
			...
			this->m_pVInputDATA_IF_Set->Concurrent_wait_get_pop_front_fromMUSiiCVectorSet(temp);
			if(temp.IsNotNull())
			{
				MUSiiC_LOG(logINFO) << " >>>>>>>>>> RxTask1 m_pVInputDATA_IF_Set::Concurrent_wait_get_pop_front_fromMUSiiCVectorSet,";
				MUSiiC_LOG(logINFO) << "data type    " << temp->GetDeviceType()<< " Device Name: "<< temp->GetDeviceName();
				MUSiiC_LOG(logINFO);
			}
			else
			{
				MUSiiC_LOG(logINFO) << " ****************** RxTask1 m_pVInputDATA_IF_Set::Concurrent_wait_get_pop_front_fromMUSiiCVectorSet,";
				MUSiiC_LOG(logINFO) << "NULL DATA";
				MUSiiC_LOG(logINFO);
			}
...
<<<<<<< .mine
	...
	igtl::MUSiiCVector<igtl::MessageBase::Pointer>::Pointer IF1 = igtl::MUSiiCVector<igtl::MessageBase::Pointer>::New();
	igtl::MUSiiCVector<igtl::MessageBase::Pointer>::Pointer IF2 = igtl::MUSiiCVector<igtl::MessageBase::Pointer>::New();
=======
>>>>>>> .r786
